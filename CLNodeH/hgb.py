...
class HGBDataset(InMemoryDataset):
    ...
    urls = {
        'acm': ('https://wxwmd.oss-cn-beijing.aliyuncs.com/ACM.zip'),
        'dblp': ('https://wxwmd.oss-cn-beijing.aliyuncs.com/DBLP.zip'),
        'freebase': ('https://wxwmd.oss-cn-beijing.aliyuncs.com/Freebase.zip'),
        'imdb': ('https://wxwmd.oss-cn-beijing.aliyuncs.com/IMDB.zip'),
    }
    ...
    def process(self):
        ...
        if self.name == 'acm':
            ...
            data_dict.pop(('paper', 'cite', 'paper'))
            data_dict.pop(('paper', 'ref', 'paper'))
            data_dict.pop(('paper', 'to', 'term'))
            data_dict.pop(('term', 'to', 'paper'))
            data = HeteroData.from_dict(data_dict)
        elif self.name == 'dblp':
            data_dict = data.to_dict()
            data_dict[('paper', 'to', 'conference')] = data_dict[('paper', 'to', 'venue')]
            data_dict[('conference', 'to', 'paper')] = data_dict[('venue', 'to', 'paper')]
            data_dict.pop(('paper', 'to', 'venue'))
            data_dict.pop(('venue', 'to', 'paper'))
            data_dict['conference'] = data_dict['venue']
            data_dict.pop('venue')
            data = HeteroData.from_dict(data_dict)
        elif self.name == 'imdb':
            data_dict = data.to_dict()
            data_dict.pop(('movie', 'to', 'keyword'))
            data_dict.pop(('keyword', 'to', 'movie'))
            data_dict.pop('keyword')
            data = HeteroData.from_dict(data_dict)
